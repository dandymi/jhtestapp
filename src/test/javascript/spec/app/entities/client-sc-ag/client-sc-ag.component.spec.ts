...
import { ClientScAgComponent } from 'app/entities/client-sc-ag/client-sc-ag.component';
...
describe('Component Tests', () => {
  describe('ClientScAg Management Component', () => {
    let comp: ClientScAgComponent;
    let fixture: ComponentFixture<ClientScAgComponent>;
    let service: ClientScAgService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [JhtestappTestModule],
        declarations: [ClientScAgComponent],
        providers: [
          {
        ...
        .overrideTemplate(ClientScAgComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ClientScAgComponent);
